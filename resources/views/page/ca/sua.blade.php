	...
	<div class="card">
		...
		<form action="" method="post" enctype="multipart/form-data" accept-charset="utf-8">
		    ...
		    <div class="form-group"><label for="company" class=" form-control-label">Tên ca</label>
		    	<input type="text" id="txtTenCa" name="txtTenCa" value="{{$ca->tenca}}" placeholder="Nhập tên ca" class="form-control">
		    </div>
		     <div class="form-group"><label for="company" class=" form-control-label">Giờ bắt đầu</label>
		    	<input type="time" id="timeGioBatDau" name="timeGioBatDau" value="{{$ca->tgbd}}" placeholder="Nhập giờ bắt đầu" class="form-control">
		    </div>
		     <div class="form-group"><label for="company" class=" form-control-label">Giờ kết thúc</label>
		    	<input type="time" id="timeGioKetThuc" name="timeGioKetThuc" value="{{$ca->tgkt}}" placeholder="Nhập Giờ kết thúc" class="form-control">
		    </div>
