    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-text text-sm-center">
                <a href="nhanvien/suanhanvien/{{$nhanVien->id}}"><i class="fa fa-edit"></i>  Sửa</a>&nbsp;&nbsp;&nbsp;
                <a href="nhanvien/xoanhanvien/{{$nhanVien->id}}"><i class="fa fa-times-circle"></i>  Xóa</a>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                 ...
                                 <tr>
                                  ...
                                  <td>{{date('d/m/Y',strtotime($nhanVien->ngaycapcmnd))}}</td>
                                ...
                                <tr>
                                  ...
                                  <td>{{date('d/m/Y',strtotime($nhanVien->ngayvaolam))}}</td>
